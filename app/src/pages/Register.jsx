  ...
  return (
    <div className={styles.container}>
      <div className={styles.panel}>
        ...
        <h1 className={styles.panelHeading}>Únete al laboratorio</h1>
        <p className={styles.panelSub}>Solicita acceso al sistema interno. Un administrador revisará tu solicitud antes de aprobarte.</p>
      </div>
        ...
        <div className={styles.card}>
          {success ? (
            <>
              ...
              <p className={styles.subtitle}>Un administrador revisará tu solicitud y te dará acceso pronto.</p>
              <p className={styles.footer}><Link to="/app/login">← Volver al login</Link></p>
            </>
          ) : (
            <>
              <h2 className={styles.title}>Solicitar acceso</h2>
              <p className={styles.subtitle}>Completa el formulario para enviar tu solicitud.</p>
